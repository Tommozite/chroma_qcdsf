...
#include "actions/ferm/linop/eoprec_clover_fh_linop_w.h"
...
{ 
 ...
 //! Creation routine with Anisotropy
   ...
   */
  void EvenOddPrecCloverFHLinOp::create(Handle< FermState<T,P,Q> > fs, 
  ...
  void 
  EvenOddPrecCloverFHLinOp::oddOddLinOp(LatticeFermion& chi, const LatticeFermion& psi, 
  ...
  void 
  EvenOddPrecCloverFHLinOp::evenEvenLinOp(LatticeFermion& chi, const LatticeFermion& psi, 
					enum PlusMinus isign) const
  {
    START_CODE();
  ...
  void 
  EvenOddPrecCloverFHLinOp::evenEvenInvLinOp(LatticeFermion& chi, const LatticeFermion& psi, 
					   enum PlusMinus isign) const
  {
    START_CODE();
   ...
   */
  void 
  EvenOddPrecCloverFHLinOp::evenOddLinOp(LatticeFermion& chi, 
   ...
   */
  void 
  EvenOddPrecCloverFHLinOp::oddEvenLinOp(LatticeFermion& chi, 
				       const LatticeFermion& psi, 
				       enum PlusMinus isign) const
  {
    START_CODE();
   ...
   * \param isign   Flag ( PLUS | MINUS )   	       (Read)
   */
  void EvenOddPrecCloverFHLinOp::operator()(LatticeFermion & chi, 
					  const LatticeFermion& psi, 
					  enum PlusMinus isign) const
  {
    START_CODE();
  ...
  void 
  EvenOddPrecCloverFHLinOp::derivEvenEvenLinOp(multi1d<LatticeColorMatrix>& ds_u, 
  ...
  //! Apply the even-even block onto a source std::vector
  void 
  EvenOddPrecCloverFHLinOp::derivEvenEvenLinOpMP(multi1d<LatticeColorMatrix>& ds_u, 
  ...
  //! Apply the even-even block onto a source std::vector
  void 
  EvenOddPrecCloverFHLinOp::derivLogDetEvenEvenLinOp(multi1d<LatticeColorMatrix>& ds_u,
						   enum PlusMinus isign) const
  {
    START_CODE();
  ...
  void 
  EvenOddPrecCloverFHLinOp::derivEvenOddLinOp(multi1d<LatticeColorMatrix>& ds_u, 
					    const LatticeFermion& chi, const LatticeFermion& psi, 
					    enum PlusMinus isign) const
  {
    START_CODE();
  ...
  void 
  EvenOddPrecCloverFHLinOp::derivOddEvenLinOp(multi1d<LatticeColorMatrix>& ds_u, 
					    const LatticeFermion& chi, const LatticeFermion& psi, 
					    enum PlusMinus isign) const
  {
    START_CODE();
  ...
  //! Apply the the odd-odd block onto a source std::vector
  void 
  EvenOddPrecCloverFHLinOp::derivOddOddLinOp(multi1d<LatticeColorMatrix>& ds_u, 
					   const LatticeFermion& chi, const LatticeFermion& psi, 
					   enum PlusMinus isign) const
  {   
    START_CODE();
  ...
  void 
  EvenOddPrecCloverFHLinOp::derivOddOddLinOpMP(multi1d<LatticeColorMatrix>& ds_u, 
					       const multi1d<LatticeFermion>& chi, const multi1d<LatticeFermion>& psi, 
					       enum PlusMinus isign) const
  {
    START_CODE();
  ...
  unsigned long EvenOddPrecCloverFHLinOp::nFlops() const
  {
  ...
  Double EvenOddPrecCloverFHLinOp::logDetEvenEvenLinOp(void) const  {
