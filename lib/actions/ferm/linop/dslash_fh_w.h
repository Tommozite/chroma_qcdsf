...
#ifndef DSLASH_FH_W_H
#define DSLASH_FH_W_H

#include "qdp_config.h"
#include "chroma_config.h"

// QDP Completely naive Dslash class
#include "lwldslash_fh_w.h"
...
namespace Chroma
{
    ...
    typedef QDPWilsonDslashFH WilsonDslashFH;
    typedef QDPWilsonDslashFHF WilsonDslashFHF;
    typedef QDPWilsonDslashFHD WilsonDslashFHD;
