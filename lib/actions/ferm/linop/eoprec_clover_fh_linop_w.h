...
#ifndef __prec_clover_fh_linop_w_h__
#define __prec_clover_fh_linop_w_h__
...
namespace Chroma
{
   ...
   *      M  =  A + (d+M) - (1/2) D'
   */
    class EvenOddPrecCloverFHLinOp : public EvenOddPrecLogDetLinearOperator<LatticeFermion,
    ...
    public:
        ...
        //! Partial constructor
        EvenOddPrecCloverFHLinOp() {}

        //! Full constructor
        EvenOddPrecCloverFHLinOp(Handle<FermState<T, P, Q>> fs,
        ...
        ~EvenOddPrecCloverFHLinOp()
        {
            QDPIO::cout << "CLOV_FH_LINOP: Time spent in clov deriv (total) = " << clov_deriv_time << std::endl;
            QDPIO::cout << "CLOV_FH_LINOP: Time spent in clov apply/invapply (total) = " << clov_apply_time << std::endl;
        }
