...
#ifndef __lwldslash_fh_base_h__
#define __lwldslash_fh_base_h__
...
namespace Chroma
{
    ...
    class WilsonDslashFHBase : public DslashLinearOperator<T, P, Q>
    {
    public:
    ...
    template <typename T, typename P, typename Q>
    unsigned long
    WilsonDslashFHBase<T, P, Q>::nFlops() const { return 1320; }
