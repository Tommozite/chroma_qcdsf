...
#include "actions/ferm/linop/eoprec_wilson_linop_fh_w.h"
...
namespace Chroma
{
   ...
   */
    void EvenOddPrecWilsonLinOpFH::create(Handle<FermState<T, P, Q>> fs,
                                          const Real &Mass_)
    {
        multi1d<Real> cf(Nd);
        cf = 1.0;
   ...
   */
                                          ...
                                          const multi1d<Real> &coeffs_)
    {
        ...
        if (coeffs.size() != Nd)
        {
            QDPIO::cerr << "EvenOddPrecWilsonLinOpFH::create : coeffs not size Nd" << std::endl;
            QDP_abort(1);
        }
   ...
   */
    void
    EvenOddPrecWilsonLinOpFH::evenOddLinOp(LatticeFermion &chi,
   ...
   */
    void
    EvenOddPrecWilsonLinOpFH::oddEvenLinOp(LatticeFermion &chi,
                                           const LatticeFermion &psi,
                                           enum PlusMinus isign) const
    {
        START_CODE();
    ...
    void EvenOddPrecWilsonLinOpFH::operator()(LatticeFermion &chi,
                                              const LatticeFermion &psi,
                                              enum PlusMinus isign) const
    {
        START_CODE();
    ...
    void
    EvenOddPrecWilsonLinOpFH::derivEvenOddLinOp(multi1d<LatticeColorMatrix> &ds_u,
    ...
    void
    EvenOddPrecWilsonLinOpFH::derivOddEvenLinOp(multi1d<LatticeColorMatrix> &ds_u,
                                                const LatticeFermion &chi,
                                                const LatticeFermion &psi,
                                                enum PlusMinus isign) const
    {
 ...
 //! Derivative of even-odd linop component
  void 
  EvenOddPrecWilsonLinOpFH::derivEvenOddLinOpMP(multi1d<LatticeColorMatrix>& ds_u,
					      const LatticeFermion& chi, 
					      const LatticeFermion& psi, 
					      enum PlusMinus isign) const
  {
  ...
  //! Derivative of odd-even linop component
  void 
  EvenOddPrecWilsonLinOpFH::derivOddEvenLinOpMP(multi1d<LatticeColorMatrix>& ds_u,
					      const LatticeFermion& chi, 
					      const LatticeFermion& psi, 
					      enum PlusMinus isign) const
  {
    ...
    unsigned long EvenOddPrecWilsonLinOpFH::nFlops() const
    {
